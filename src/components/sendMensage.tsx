...
const sendMensage: React.FC<Props> = (props) => {
  ...
  return (
    <div >
    <TextField autoComplete='false' size='small' onKeyDown={(e)=> {if(e.code==="Enter" || e.code==="NumpadEnter") props.handleAdicionarMsg()}} style={{backgroundColor: "#FFFFFF", width:'90%'}} variant="outlined" value={props.texto} onChange={(e) => props.setTexto(e.target.value as string)} />
